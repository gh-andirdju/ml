"""Private Kaggle T4 wrapper for POC 19 cuGraph-PyG full-batch Flickr."""
...
SOURCE_REVISION = "723e0b5e0b62b8d203496dd67db2e6129c56a9d2"
SOURCE_ARCHIVE = f"https://github.com/gh-andirdju/ml/archive/{SOURCE_REVISION}.zip"
temporary = Path("/kaggle/temp/ml-poc-19")
...
subprocess.run(
    [
        sys.executable,
        str(project / "poc" / "run_kaggle_fullbatch_cugraph_pyg_cuda.py"),
    ],
    cwd=project,
    env={
        **os.environ,
