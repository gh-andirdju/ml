"""Private Kaggle CPU-only kernel wrapper for POC 11."""
...
SOURCE_REVISION = "8e09f961c3a172bd3464aa0a4626ed0ba7ada3bb"
SOURCE_ARCHIVE = f"https://github.com/gh-andirdju/ml/archive/{SOURCE_REVISION}.zip"
temporary = Path("/kaggle/temp/ml-poc-11")
...
process = subprocess.Popen(
    [sys.executable, str(project / "poc" / "run_kaggle_flickr_2048_cpu.py")],
    cwd=project,
...
Path("/kaggle/working/flickr-2048-cpu-resource-usage.json").write_text(
