"""Private Kaggle single-T4 CUDA kernel wrapper for POC 10."""
...
temporary = Path("/kaggle/temp/ml-poc-10")
...
subprocess.run(
    [sys.executable, str(project / "poc" / "run_kaggle_flickr_wide_cuda.py")],
    cwd=project,
