"""Private Kaggle CPU-only kernel wrapper for POC 13."""
...
SOURCE_REVISION = "bb766a2055fca069889799b7ce8cfc4762886e29"
SOURCE_ARCHIVE = f"https://github.com/gh-andirdju/ml/archive/{SOURCE_REVISION}.zip"
temporary = Path("/kaggle/temp/ml-poc-13")
...
process = subprocess.Popen(
    [sys.executable, str(project / "poc" / "run_kaggle_flickr_4096_cpu.py")],
    cwd=project,
...
Path("/kaggle/working/flickr-4096-cpu-resource-usage.json").write_text(
