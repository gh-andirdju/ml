"""Private Kaggle CPU-only kernel wrapper for POC 9."""
...
SOURCE_REVISION = "d4115e3e408f992354a7ceced768d3e19977b54b"
SOURCE_ARCHIVE = f"https://github.com/gh-andirdju/ml/archive/{SOURCE_REVISION}.zip"
temporary = Path("/kaggle/temp/ml-poc-9")
...
process = subprocess.Popen(
    [sys.executable, str(project / "poc" / "run_kaggle_flickr_wide_cpu.py")],
    cwd=project,
...
Path("/kaggle/working/flickr-wide-cpu-resource-usage.json").write_text(
