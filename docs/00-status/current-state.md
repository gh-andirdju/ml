...
Observed and verified on 2026-09-06.
...
| GNN | All fourteen execution POCs pass; all six workloads have MPS/CPU/T4 records |
...
| 2,048-channel pair | PASS: T4 is 26.888x faster; 10.35 GB allocated, 13.90 GB reserved |
| 4,096-channel pair | PASS: T4 is 38.388x faster; 11.10 GB allocated, 15.25 GB reserved |
| Three-environment matrix | PASS: all 18 pairwise/environment cells recorded |
