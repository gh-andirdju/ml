...
CUGRAPH_PYG_KAGGLE_SOURCE_REVISION = "62849be3b1256035d092f1ee98394749df1fd1bc"
...
CUGRAPH_PYG_FLICKR_KAGGLE_SPEC = ArtifactSpec(
    poc_id="kaggle-flickr-cugraph-pyg-t4-v1",
    target_poc_id="comparison-only",
    dataset_name="Flickr",
    nodes=89_250,
    classes=7,
